...
class SortingValidatorTest {
    ...
    void testValidBubbleSort(){
        GameState gameState = new GameState("Bubble_Sort", Arrays.asList(5, 3, 4, 1));
    ...
    void testBubbleSortAlgorithm(){
        ...
        GameState gameState = new GameState("Bubble_Sort", array);
    ...
    void testInvalidSelectionSortInitial(){
        GameState gameState = new GameState("selection_sort", Arrays.asList(5,4,1,3,2));
    ...
    void testSelectionSortAlgorithm(){
        ...
        GameState gameState = new GameState("selection_sort", array);
        int minIndex;
    ...
    void testInsertionSortInitial(){
        GameState gameState = new GameState("insertion_sort",Arrays.asList(5,4,1,3,2));
        assertFalse(SortingValidator.isValidSortParameters(gameState, 1,0,1));
    ...
    void testInsertionSortAlgorithm(){
        ...
        GameState gameState = new GameState("insertion_sort",array);
